...
The data is from [basketball-reference.com](www.basketball-reference.com). First, a year's [draft class](http://www.basketball-reference.com/draft/NBA_2016.html) was pulled, then this was joined with that same season's [player statistics](http://www.basketball-reference.com/leagues/NBA_2017_advanced.html). This was done for every year 1989 - 2016. The follwing script was used to scrape and prepare the data for analysis. 
