...
Many of the most important words are taken directly from the title, which means it works fairly well. There are also many episodes where character names unique to that episode are most important, but there are other ones which are very interesting. 
